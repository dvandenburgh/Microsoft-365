<##################################################################################################	
	...
	1. [All cloud apps] GRANT: Require MFA for Admin users
	2. [All cloud apps] GRANT: Require MFA for All users
	3. [All cloud apps] BLOCK: Unsupported device platforms
	4. [Office 365] GRANT: Require approved app for mobile access (MAM)
	5. [Office 365] GRANT: Require compliant device for supported platforms
	6. [Office 365] SESSION: Prevent downloads from unmanaged devices and browsers
	.NOTES
